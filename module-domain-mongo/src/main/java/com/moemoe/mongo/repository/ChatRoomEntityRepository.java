...
public interface ChatRoomEntityRepository extends MongoRepository<ChatRoomEntity, ObjectId>, ChatRoomEntityUpdateRepository, ChatRoomEntityFindingRepository {
}
